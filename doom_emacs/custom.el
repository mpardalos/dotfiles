(custom-set-variables
 ...
 '(custom-safe-themes
   '("d97ac0baa0b67be4f7523795621ea5096939a47e8b46378f79e78846e0e4ad3d"
     ...
     "c4ec44cce043a30c57dd3a1342a890991976a872cd71f4c0650c9387a66eb3f4"
     "2c9dc3ab1cbde9d4a3cd129b945d39e19fe7107708edec589118b14d24c01dac"
 ...
 '(safe-local-variable-values
   '((org-latex-caption-above) (eval ansible 1)
     (lsp-haskell-server-path . "haskell-language-server")
     (eval add-to-list 'auto-mode-alist '("\\.v\\'" . verilog-mode))
     (counsel-compile-local-builds
      "ssh pardalos@rs6 \"echo 'make -C /work/pardalos/vhdl.mp/npchip/tb/assembler -j' | tcsh -s\""
      "ssh pardalos@rs6 \"echo 'cd /work/pardalos/vhdl.mp/np5chip/ && go -p:\"-log4 /work/pardalos/npasm_log.cfg\" -E lava' | tcsh -s\""
      "ssh pardalos@rs6 \"echo 'cd /work/pardalos/vhdl.mp/np5chip/ && go -p:\"-log4 /work/pardalos/npasm_log.cfg\" -P lava' | tcsh -s\"")
     (counsel-compile-local-builds
      "ssh pardalos@rs6 \"echo 'make -C /work/pardalos/vhdl.mp/npchip/tb/assembler -j' | tcsh -s\""
      "ssh pardalos@rs6 \"echo 'cd /work/pardalos/vhdl.mp/np5chip/ && go -E lava' | tcsh -s\""
      "ssh pardalos@rs6 \"echo 'cd /work/pardalos/vhdl.mp/np5chip/ && go -P lava' | tcsh -s\"")
     (counsel-compile-local-builds
      "ssh pardalos@rs6 \"echo 'make -C /work/pardalos/vhdl.mp/npchip/tb/assembler -j' | tcsh -s\"")
     (counsel-compile-local-builds "./mk bringup.x86hops noarmhops" "./mk"
      "./regress")
 ...
 '(vertico-posframe-width 120 nil nil "Full width is too wide")
