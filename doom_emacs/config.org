...
(map!
 :mode prog-mode
 :desc "Claude Code" :leader "l" #'claudemacs-transient-menu)
#+end_src
...
#+end_src
** Flymake
Give a long delay to the popon but add keybind to manually trigger it.
#+begin_src elisp :tangle yes
(setq! flymake-popon-delay 9999)
(map! :leader :desc "Hover" "h" (cmd! (flymake-popon--show)))
#+end_src
